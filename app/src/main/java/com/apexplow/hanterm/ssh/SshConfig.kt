 ...
 */
object SshConfig {
    /** Default SSH port — matches the SharedPreferences default in [com.apexplow.hanterm.data.prefs.AppPreferences]. */
    ...
    /**
     * How often [com.apexplow.hanterm.ssh.SshKeepAliveService] writes an
