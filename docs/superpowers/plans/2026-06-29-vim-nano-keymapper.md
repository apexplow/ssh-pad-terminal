...
```bash
./gradlew :app:testDebugUnitTest --tests "com.apexplow.hanterm.terminal.KeyEventRoutingTest.test_keyMapTable_isWellFormed"
```
...
```bash
./gradlew :app:testDebugUnitTest --tests "com.apexplow.hanterm.terminal.*"
```
