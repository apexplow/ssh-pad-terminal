 ...
 *
 * Modelled as a sealed class so the [com.apexplow.hanterm.ssh.SshClient]
 ...
 *  - password (read out of the Keystore-encrypted blob in [com.apexplow.hanterm.data.prefs.AppPreferences])
 *  - public-key (PEM file imported via SAF, stored under `filesDir/keys/`)
 *
 * Neither carries the username — that flows through [com.apexplow.hanterm.ssh.SshClient.connect]
...
sealed class Auth {
     ...
     * [com.apexplow.hanterm.data.prefs.AppPreferences.privateKeyName] +
