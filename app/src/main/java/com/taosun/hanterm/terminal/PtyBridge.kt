 ...
 * [com.taosun.hanterm.ssh.SshSession] at
...
interface PtyBridge {
     ...
     * The shape mirrors [com.taosun.hanterm.terminal.TerminalView.setPtyResizeListener]
 ...
 * [com.taosun.hanterm.ssh.SshTransport] (the four-method
 * interface that backs [com.taosun.hanterm.ssh.SshSession]):
...
interface PtyEndpoint {
     ...
     * are silent no-ops (mirrors [com.taosun.hanterm.ssh.SshSession.write]),
