 ...
 * an [SshSession] exactly the way it targets a [com.taosun.hanterm.terminal.MockEchoSession] —
 * no changes needed in [com.taosun.hanterm.terminal.TerminalInputConnection]
 * or [com.taosun.hanterm.terminal.TerminalView]. The Sprint 1.5 IME chain
...
class SshSession internal constructor(
     ...
     * watchdog in [com.taosun.hanterm.ssh.SshBridgeAdapter] sets the
     ...
     * [com.taosun.hanterm.ssh.SshBridgeAdapter] just before it invokes
     ...
     * [com.taosun.hanterm.terminal.TerminalView]'s layout listener when
