...
/**
 * Process-scoped marker that [com.taosun.hanterm.ssh.SshSession] raises
 * when its `readInto` loop catches a known teardown exception
 * (SocketException / SSHException / SocketTimeoutException / etc.).
 *
 * [com.taosun.hanterm.CrashHandler] consults [isRecent] when sshj's
 ...
 * can arrive shortly AFTER [com.taosun.hanterm.ssh.SshSession.readInto]
