...
import com.example.sshterminal.ssh.security.HostKeyPromptRequest
import kotlinx.coroutines.CompletableDeferred
import kotlinx.coroutines.flow.MutableStateFlow

/**
 * Bridges [KnownHostsVerifier][com.example.sshterminal.ssh.security.KnownHostsVerifier]'s
 ...
 * [com.example.sshterminal.ssh.SshClient] instance it's wired into; only one
