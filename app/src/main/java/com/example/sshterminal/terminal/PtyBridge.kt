 ...
 * [com.example.sshterminal.ssh.SshSession] at
...
interface PtyBridge {
     ...
     * The shape mirrors [com.example.sshterminal.terminal.TerminalView.setPtyResizeListener]
 ...
 * [com.example.sshterminal.ssh.SshTransport] (the four-method
 * interface that backs [com.example.sshterminal.ssh.SshSession]):
...
interface PtyEndpoint {
     ...
     * are silent no-ops (mirrors [com.example.sshterminal.ssh.SshSession.write]),
